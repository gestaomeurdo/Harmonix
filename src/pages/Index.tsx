...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7]">
      ...
      {/* Hero Section - Elite Minimalist */}
      <section className="relative pt-40 pb-52 px-6">
        <div className="container mx-auto max-w-6xl text-center">
          <div className="inline-flex items-center gap-3 text-[#A855F7] mb-12 animate-pulse">
            <Sparkles size={16} strokeWidth={1} />
            <span className="text-[9px] font-bold uppercase tracking-[0.5em]">Curadoria de Elite</span>
          </div>
          
          <h1 className="text-6xl md:text-[7rem] font-light text-[#1A1A1A] mb-16 leading-[0.95] tracking-tighter">
            A excelência em cada detalhe da sua <br />
            <span className="italic font-serif opacity-80">beleza.</span>
          </h1>
          ...
          {/* Elite Search - Floating & Minimalist */}
          <div className="max-w-2xl mx-auto relative group">
            <div className="absolute inset-0 bg-[#A855F7]/5 blur-[100px] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />
            <div className="relative bg-white border border-gray-100 p-2 rounded-full flex items-center shadow-[0_30px_60px_-15px_rgba(0,0,0,0.03)] transition-all duration-700 hover:shadow-[0_40px_100px_-15px_rgba(0,0,0,0.08)]">
              ...
              <button className="bg-[#1A1A1A] text-white rounded-full px-12 h-14 text-[10px] font-bold uppercase tracking-[0.3em] hover:bg-[#5B2EFF] transition-all duration-500 shadow-xl shadow-black/5">
                Explorar
              </button>
            </div>
          </div>
      ...
      {/* Categories */}
      <section className="py-24 border-y border-gray-100 bg-white/50">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-32 gap-10">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-gray-400 font-light tracking-wide leading-relaxed">
                Uma seleção rigorosa dos profissionais que estão redefinindo os padrões da estética facial contemporânea através da técnica e do olhar artístico.
              </p>
            </div>
            <Link to="/profissionais" className="group flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.4em] text-[#1A1A1A] border-b border-[#1A1A1A] pb-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {featured.length > 0 ? (
              ...
              <div className="col-span-full py-20 text-center text-gray-300 font-light tracking-widest uppercase text-sm">
